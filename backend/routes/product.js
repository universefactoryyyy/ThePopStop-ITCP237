...
const { getAllProducts, getSingleProduct, createProduct, updateProduct, deleteProduct, restoreProduct, uploadPhotos, searchAutocomplete } = require('../controllers/product');
